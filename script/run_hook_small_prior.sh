...
for i in $list; do
    python train.py --eval \
        ...
        -m output/NeRF_Syn/$i/3dgs_sprior \
    ...
    python eval_nvs.py --eval \
        -m output/NeRF_Syn/${i}/3dgs_sprior \
        -c output/NeRF_Syn/${i}/3dgs_sprior/chkpnt30000.pth

    python train.py --eval \
        -s datasets/nerf_synthetic/$i/ \
        -m output/NeRF_Syn/$i/neilf_sprior \
        -c output/NeRF_Syn/$i/3dgs_sprior/chkpnt30000.pth \
        --save_training_vis \
    ...
    python eval_nvs.py --eval \
        -m output/NeRF_Syn/${i}/neilf_sprior \
        -c output/NeRF_Syn/${i}/neilf_sprior/chkpnt40000.pth \
        -t neilf
done
