...
root_dir="/home/jk/Dynamic-2DGS-relightable/data/d-nerf-relight"
...
for i in $list; do
    ...
    #     -s /home/jk/Dynamic-2DGS-relightable/data/d-nerf-relight/$object/ \
    #     -m output/our_ds/$i/$object/3dgs \
    ...
    #     -s /home/jk/Dynamic-2DGS-relightable/data/d-nerf-relight/$object/ \
    #     -envmap_prefix $i \
    #     -m output/our_ds/$i/$object/neilf \
    #     -c output/our_ds/$i/$object/3dgs/chkpnt30000.pth \
    #     --save_training_vis \
    ...
    #     --rotation_lr 0.0001 \
    #     --iterations 40000 \
    #     --lambda_base_color$object_smooth 0 \
    ...
    #     -m output/our_ds/${i}/$object/neilf \
    #     -c output/our_ds/${i}/$object/neilf/chkpnt40000.pth \
    #     -t neilf \
    #     --resolution 2
done